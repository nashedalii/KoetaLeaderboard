...
export default function DriverVisualisasi() {
  ...
  const generateAutoNotes = () => {
    ...
    const components = [
      { key: 'etikaAdab', label: 'Etika & Adab', emoji: '🙏', color: '#ef4444', bobot: bobotPenilaian.etikaAdab },
      { key: 'disiplin', label: 'Kedisiplinan', emoji: '⏰', color: '#3b82f6', bobot: bobotPenilaian.disiplin },
      { key: 'loyalitas', label: 'Loyalitas', emoji: '❤️', color: '#10b981', bobot: bobotPenilaian.loyalitas },
      { key: 'skillMengemudi', label: 'Skill Mengemudi', emoji: '🚗', color: '#f59e0b', bobot: bobotPenilaian.skillMengemudi },
      { key: 'perawatanKendaraan', label: 'Perawatan Kendaraan', emoji: '🔧', color: '#a855f7', bobot: bobotPenilaian.perawatanKendaraan },
      { key: 'performa', label: 'Performa', emoji: '⚡', color: '#ec4899', bobot: bobotPenilaian.performa }
    ]
